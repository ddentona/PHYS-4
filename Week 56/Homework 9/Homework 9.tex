...
\begin{document}
    ...
    % \begin{multicols}{2}
        ...
        \subsection{Question 15}
            ...
            \subsubsection{Answer}
                ...
                \scriptsize
                \begin{align}
                    \hat{H} &=  -\frac{\hbar^2}{2m_1}\nabla_1^2 - \frac{1}{4\pi\varepsilon_0} \frac{Ze^2}{r_1} - \frac{\hbar^2}{2m_1}\nabla_2^2 - \frac{1}{4\pi\varepsilon_0} \frac{Ze^2}{r_2} + \frac{1}{4\pi\varepsilon_0} \frac{e^2}{\left| \left| \vec{r}_1 - \vec{r}_2 \right| \right|}
                \end{align}
                ...
                \begin{gather}
                    ...
                    \hat{H}_1 = -\frac{\hbar^2}{2m_1}\nabla_1^2 - \frac{1}{4\pi\varepsilon_0} \frac{Ze^2}{r_1} + \frac{1}{4\pi\varepsilon_0} \frac{e^2}{\left| \left| \vec{r}_1 - \vec{r}_2 \right| \right|}\\
    ...
    \section{Problem 1}
        ...
        \subsection{Solution}
            ...
            Multiplying the 14 values of the first by the 13 values of the second and dividing by two to account for doubles, we get \boxed{91} distinct states.
        \pagebreak
    ...
    \section{Problem 3}
        ...
        \subsection{Solution}
            ...
            You can multiply this out more, but the determinant is completed, so I just won't expand go further.
    \pagebreak
