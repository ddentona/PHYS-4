...
Number 4 has one disagreeing charge like number 3, but it is closer than number 3's field. This means that its field on the point has a greater impact on it because distance is inversely proportional to field strength. As such, the magnitude is less than the magnitude of (3). \boxed{(2) > (3) > (4) > (1)}
