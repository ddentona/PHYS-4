...
\begin{document}
    ...
    \begin{gather*}
        ...
        E_n = \frac{n^2\pi^2\hbar^2}{2m(b - a)^2} \approx \frac{n^2 * 54.8\E{-69}\,\unit{\joule^2\cdot\second^2}}{m(b - a)^2}
            \approx \frac{n^2 * 4.276\E{-30}\,\unit{\eV^2\cdot\second^2}}{m(b - a)^2}
    \end{gather*}
    ...
    \underline{Relativity}
        ...
        \begin{gather*}
            ...
            v = \frac{p}{\sqrt{m^2 + p^2/c^2}} = c\sqrt{1 - \left( \frac{mc^2}{E} \right)}
        \end{gather*}
\end{document}