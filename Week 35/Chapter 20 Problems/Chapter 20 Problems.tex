...
\begin{document}
    ...
    \section{Problem 7}
        ...
        \subsection{Solution (a)}
            ...
            \begin{gather}
                Q_{\rm Cu}  =   Q_{\rm Pb}\\
                c_{\rm Cu} m_{\rm Cu}\,\left| \Delta T_{\rm Cu} \right| = c_{\rm Pb} m_{\rm Pb}\,\left| \Delta T_{\rm Pb} \right|\\
        ...
        \subsection{Solution (b)}
            We can use the first law of thermodynamics here.
            This involves finding the change in work in each.
            We already have the formula for the change in heat for each body.
            Note that the volume is not constant for either and can be calculated using coefficients of expansion.
