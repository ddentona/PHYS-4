...
\begin{document}
    ...
    \section{Problem 20}
        ...
        \end{center}
        Figure 17-36 shows four isotropic point sources of sound that are uniformly spaced on an x axis. The sources emit sound at the same wavelength $\lambda$ and same amplitude sm, and they emit in phase. A point P is shown on the x axis. 
