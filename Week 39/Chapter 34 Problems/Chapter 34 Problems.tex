...
\begin{document}
    ...
    \pagebreak
    \section{Problem 1}
        You look through a camera toward an image of a hummingbird
in a plane mirror. The camera is 4.30 m in front of the mirror. The bird
is at camera level, 5.00 m to your right and 3.30 m
from the mirror. What is the distance between the
camera and the apparent position of the bird's image
in the mirror?
...
S is positioned at distance d from
a viewing screen A and the light
intensity I P at point P (level with S)
is measured. Then a plane mirror
M is placed behind S at distance d.
By how much is I P multiplied by the
