...
\begin{document}
    ...
    \section{Problem 59}
        \begin{wrapfigure}{r}{0.25\textwidth}
            \vspace{-30pt}
            \includegraphics[width=0.25\textwidth]{picture_19-26.png} 
            % \label{fig:wrapfig}
        \end{wrapfigure}
    ...
    \section{Problem 69}
        ...
        Assume that the surrounding air, at 20.0°C, has a weight per unit volume of 11.9 N/m 3 and a molecular mass of 0.028 kg/mol, and is at a pressure of 1.0 atm.
