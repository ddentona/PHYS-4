...
\begin{document}
    ...
    \section{Problem 27}
        ...
        (a) Find $\epsilon$. 
        (b) What is the ratio of $\epsilon$ to the average kinetic energy of $H_2O$ molecules, assuming the latter is related to temperature in the same way as it is for gases?
